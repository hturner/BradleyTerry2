# old test of BTabilities - all parameters are estimable, not sure what this was about
...
# old test of grouped residuals - there is no "separate" attribute here, has behaviour changed?
