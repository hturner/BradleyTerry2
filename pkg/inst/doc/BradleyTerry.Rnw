...
str(CEMS)
@ %def 
The names of the data frames are not used by \code{BTm}, but help to clarify
the structure. The rows should either correspond to the contests or the levels
of the factor used for indexing.
