...
#' @name springall
#' @docType data
#' @format A list containing two data frames, \code{springall$contests} and
...
#' \code{win + tie/2}} 
#' \item{loss.adj}{numeric, equal to \code{loss +
#' tie/2}} }
#' 
...
#' the American Statistical Association}, \bold{63}, 194--204.
